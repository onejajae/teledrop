...
internal static class DropSlugGenerator
{
    ...
    internal static IEnumerable<string> CreateCandidates()
    {
        for (var attempt = 0; attempt < CombinationAttempts; attempt++)
        {
            yield return CreateWordCombination();
        }
