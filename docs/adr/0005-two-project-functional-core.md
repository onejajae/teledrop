...
> 프로젝트 배치는 [ADR 0007](0007-infrastructure-and-composition-root.md)의 세 프로젝트 구성으로 대체했다. Core의 의존 방향과 최소 port 원칙은 유지한다. 아래 업로드 티켓 관련 예시와 구성은 도입 당시 기록이며, 해당 기능은 [ADR 0006](0006-remove-guest-upload.md)으로 제거했다.

- 상태: 채택 (프로젝트 배치는 ADR 0007로 대체)
- 날짜: 2026-07-27
